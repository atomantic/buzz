# Your stdlib service: antic/buzz
...
example, `antic/buzz/buzz` would map to the first
...
The entry point to your function described in `f/buzz/function.json`.
